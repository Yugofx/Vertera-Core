...
import { WOR_INPUT_VALUE_ACCESSOR } from './input-value-accessor';
...
@Directive({
  selector: `input[wor-input], textarea[wor-input]`,
  host: {
    'class': 'form-control',
    '[attr.id]': 'id',
...
export class WorInput implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    @Optional() @Self() @Inject(WOR_INPUT_VALUE_ACCESSOR) inputValueAccessor: any,
  ) {
